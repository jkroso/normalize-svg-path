...
t('arc-to', t => {
  t.deepEqual(
    f32(normalize(parse('M10 80 A150 150 0 0 0 150 80'))),
    f32(parse('M 10 80C 53.80473794537901 103.1133445143787 106.19526205462094 103.1133445143787 149.99999999999997 80.00000000000003'))
  )

  // half circle clockwise
  t.deepEqual(
    f32(normalize(parse('M10 80 A50 50 0 0 1 150 80'))),
    f32(parse('M 10 80C 10 41.340067511844474 41.34006751184445 10.000000000000014 79.99999999999999 10C 118.65993248815552 10 150 41.34006751184445 150 79.99999999999999'))
  )

  // half circle anticlockwise
  t.deepEqual(
    f32(normalize(parse('M10 80 A50 50 0 1 0 150 80'))),
    f32(parse('M 10 80C 10.000000000000014 118.65993248815553 41.340067511844474 150 80 150C 118.65993248815553 150 150 118.65993248815553 150 80'))
  )

  // circle
  t.deepEqual(
    f32(normalize(parse('M10 80 A50 50 0 0 1 150 80 A50 50 0 0 1 10 80'))),
    f32(parse('M 10 80C 10 41.340067511844474 41.34006751184445 10.000000000000014 79.99999999999999 10C 118.65993248815552 10 150 41.34006751184445 150 79.99999999999999C 150 118.65993248815553 118.65993248815553 150 80 150C 41.340067511844474 150 10.000000000000014 118.65993248815553 10 80.00000000000001'))
  )
